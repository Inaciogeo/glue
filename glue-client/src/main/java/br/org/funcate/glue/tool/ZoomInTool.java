...
public class ZoomInTool implements Tool {
	...
	public ZoomInTool() {
		...
		ImageIcon imgIconZoomIn = ImageIconLoader.createImageIcon("br/org/funcate/glue/image/cursor01.gif", ToolRedirectionService.class);
		cursor = Toolkit.getDefaultToolkit().createCustomCursor(imgIconZoomIn.getImage(), new Point(10, 10), "Mais zoom");
	...
	private void handle(MousePressedEvent e) throws Exception {
		...
		ZoomToolService.pressZoomIn((int) point[0], (int) point[1]);
