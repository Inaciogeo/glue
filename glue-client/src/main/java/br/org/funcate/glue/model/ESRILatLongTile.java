...
public class ESRILatLongTile {
	...
	static double originLatitude = 71.5323878134;
	static double originLongitude = -125.1420042616;
	public static PointF originLocation = new PointF(originLongitude*CDR,originLatitude*CDR);	
	/* Constructor*/
