/**
 * \file DescribeLayer.java
 * This class represents the DescribeLayer node of the XML.
 */
...
/**
 * 
 * \brief This class represents the DescribeLayer node of the XML.
 * 
...
public class DescribeLayer {
	...
	/**
	 * \brief Sets the value of the format property.
	 * 
	 * @param value
