/**
 * @see http://www.informit.com/guides/content.aspx?g=java&seqNum=236
 */
...
import br.org.funcate.glue.controller.OutlookBarController;
...
public class JOutlookBar extends JPanel implements ActionListener {
	...
	public JOutlookBar() {
		...
		new OutlookBarController(this);
	}

	public void updateBar(String name, JComponent component) {
		BarInfo barInfo = (BarInfo) this.bars.get(name);
		barInfo.setComponent(component);
		render();
	}
	 ...
	 */
	public JComponent getBarComponent(String name){
		BarInfo barInfo = (BarInfo) this.bars.get(name);
		if (barInfo != null && barInfo.getComponent() != null){
			return barInfo.getComponent();
		}
		return null;
	}
	/**
	...
	public static void main(String[] args) {
		...
		outlookBar.updateBar("Three", getDummyPanel("Mudei"));
	}
	...
	public void setLastVisibleBar() {
		setVisibleBar(bars.size() - 1);
	}
