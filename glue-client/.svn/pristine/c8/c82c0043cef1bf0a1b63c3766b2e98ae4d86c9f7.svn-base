...
public class TableControllerTriggerReflection {
	...
	private TableEventComparator tableComparator;
	/** Class comparator */
	...
	private Object[] methodReflection(String nameMethodClass, Object instance, String nameMethod, String caminhoNomeClasse,
		...
		try {
			...
			try {
				...
				throw new GlueClientException("methodReflection() - The parameters of the method '" + nameMethod + "' are null.", e);
			}

			pContem = parametrosMetodo;
			aux[1] = pContem;

			Method something = obje.getClass().getDeclaredMethod(nameMethod, pvec);
			aux[2] = something;
			...
			throw new GlueClientException("methodReflection() - Method Not Found: Check the name, or the address(package)", e);
	...
	public void forInvoke(String nameMethodClass) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
	...
	public Object[] reflectionObjects(String nameMethodClass, Object instance, String nameMethod, String pathNameClass,
			Object... paramsMethod) throws GlueClientException {

		Object[] listeners = new Object[5];

		listeners = methodReflection(nameMethodClass, instance, nameMethod, pathNameClass, paramsMethod);
	...
	private Method findMethod(String name, Method[] aux, Object[] parametrosMetodo) throws GlueClientException {
		...
		try {
			...
			throw new GlueClientException("findReflection() - The parameters of the method '" + name + "' are null.", e);
	...
	public boolean addListener(String nameMethodClass, Object instance, String nameMethod, String pathNameClass, Object... paramsMethod)
			throws GlueClientException {

		try {

			Object[] listener = reflectionObjects(nameMethodClass, instance, nameMethod, pathNameClass, paramsMethod);
	...
	public boolean removeListener(String nameMethodClass, Object instance, String nameMethod, String pathNameClass, Object... paramsMethod)
			throws GlueClientException {
	...
	public boolean removeAll() throws GlueClientException {
		...
		try {
			...
			throw new GlueClientException("removeAll() - Não foi possível remover os métodos da lista.", e);
		}
